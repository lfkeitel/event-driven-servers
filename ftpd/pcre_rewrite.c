 ...
 * All rights reserved.
 *
 * $Id: pcre_rewrite.c,v 1.16 2020/03/05 19:48:48 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: pcre_rewrite.c,v 1.16 2020/03/05 19:48:48 marc Exp marc $";
