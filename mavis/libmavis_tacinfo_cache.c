 ...
 * All rights reserved.
 * 
 * $Id: libmavis_tacinfo_cache.c,v 1.10 2021/03/21 08:57:21 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_tacinfo_cache.c,v 1.10 2021/03/21 08:57:21 marc Exp marc $";
